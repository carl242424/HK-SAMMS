...
export default function CheckerHeader() {
  ...
  const menuItems = [
    { name: 'Dashboard', icon: 'home', screen: 'ACDashboard' },
    { name: 'Attendance Encoding', icon: 'document-text', screen: 'Encoding' },
    { name: 'QR Check-In', icon: 'qr-code', screen: 'QRCheckIn' },
    { name: 'QR Scanner', icon: 'scan', screen: 'QRScanner' },
    { name: 'My Profile', icon: 'person-circle', screen: 'Profile' },
